angular.module('moviesowlApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('www/templates/cinemas.html',
    ...
    " \t--><ion-content><ion-refresher pulling-text=\"Pull to update app...\" on-refresh=\"doRefresh()\"></ion-refresher><h1>FARRRRK 333</h1><ion-list><ion-item ng-repeat=\"cinema in cinemas\" href=\"#/movies/{{cinema.id}}/?cinemaLocation={{cinema.location}}\">{{cinema.location}}</ion-item></ion-list></ion-content></ion-view>"
  );
